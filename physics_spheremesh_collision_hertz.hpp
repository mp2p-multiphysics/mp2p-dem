...
class PhysicsSphereMeshCollisionHertz : public PhysicsBase
{
    ...
    // function
    void compute_force_pair(CollisionSphereMeshPair collision_pair);
...
void PhysicsSphereMeshCollisionHertz::compute_force_pair(CollisionSphereMeshPair collision_pair)
{
