...
class CollisionCheckSphereSphereSweep1Dz
{
    ...
    // default constructor
    CollisionCheckSphereSphereSweep1Dz()
    {

    }

    // constructor
    CollisionCheckSphereSphereSweep1Dz(VectorDouble radius_vec_in, double enlarge_factor_in = 0.05)
    {
...
void CollisionCheckSphereSphereSweep1Dz::set_input(VectorDouble &radius_vec_in)
{
...
VectorPairInt CollisionCheckSphereSphereSweep1Dz::broad_search(SpherePositionVelocityStruct &sphere_pvs)
{
    ...
    int num_bound_c = 2*sphere_pvs.num_particle;
    ...
    for (int rank = 0; rank < num_bound_c; rank++)
    {
        ...
        if (is_lower_bound)
        {
            ...
            {
                std::pair<int, int> pair_sub = {indx_active_z_vec[i], indx_i};
                if (indx_active_z_vec[i] > indx_i)
                {
                    pair_sub = {indx_i, indx_active_z_vec[i]};
                }
