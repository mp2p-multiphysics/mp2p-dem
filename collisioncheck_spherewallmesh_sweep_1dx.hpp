#ifndef COLLISIONCHECK_SPHEREWALLMESH_SWEEP_1DX
#define COLLISIONCHECK_SPHEREWALLMESH_SWEEP_1DX
#include <utility>
#include <vector>
...
class CollisionCheckSphereWallMeshSweep1Dx
{
    ...
    // default constructor
    CollisionCheckSphereWallMeshSweep1Dx()
    {

    }

    // constructor
    CollisionCheckSphereWallMeshSweep1Dx(VectorDouble radius_vec_in, double enlarge_factor_in = 0.05)
    {
...
void CollisionCheckSphereWallMeshSweep1Dx::set_input(VectorDouble &radius_vec_in)
{
...
VectorPairInt CollisionCheckSphereWallMeshSweep1Dx::broad_search(SpherePositionVelocityStruct &sphere_pvs, WallMeshPositionVelocityStruct &wallmesh_pvs)
{
...
void CollisionCheckSphereWallMeshSweep1Dx::sort_pair_insertion(VectorPairIntDouble &pair_vec)
{
