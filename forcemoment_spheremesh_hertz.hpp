...
void ForceMomentSphereMeshHertz::compute_force_pair(int gid_i, int gid_j)
{
    ...
    Mesh mesh_j = meshgroup_ptr->mesh_vec[tid_j];
    ...
    std::pair<int, int> collision_pair = {sphere_i.gid, gid_j};
