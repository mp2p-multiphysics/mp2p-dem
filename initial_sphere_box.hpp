#ifndef INITIAL_SPHERE_BOX
#define INITIAL_SPHERE_BOX
#include <algorithm>
#include <cstdlib>
#include <random>
#include <vector>
...
class InitialSphereBox : public InsertDeleteBase
{
    /*
    ...
    */
    ...
    InitialSphereBox(
        ...
        EigenVector3D position_min_in, EigenVector3D position_max_in, double radius_ratio_in = 0,
...
void InitialSphereBox::initialize(double dt_in)
{
    /*
...
bool InitialSphereBox::check_overlap(const Sphere &sphere_test, const std::vector<Sphere, Eigen::aligned_allocator<Sphere>> &sphere_vec)
{
