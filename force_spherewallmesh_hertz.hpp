#ifndef FORCE_SPHEREWALLMESH_HERTZ
...
class ForceSphereWallMeshHertz
{
...
void ForceSphereWallMeshHertz::add_force_moment(
    SphereForceMomentStruct &sphere_fms,
    SparseMatrixDouble &overlap_tangent_smat,
    SparseMatrixDouble &relative_velocity_tangent_smat,
    SpherePositionVelocityStruct &sphere_pvs,
...
)
{
    ...
    for (auto &collision_pair : collision_vec)
    {
        ...
        // calculate forces
        calculate_force_moment(sphere_fms, overlap_tangent_smat, relative_velocity_tangent_smat, sphere_pvs, wallmesh_pvs, indx_i, indx_k);
        
    }

}

void ForceSphereWallMeshHertz::calculate_force_moment(
    SphereForceMomentStruct &sphere_fms,
    SparseMatrixDouble &overlap_tangent_smat,
    SparseMatrixDouble &relative_velocity_tangent_smat,
    SpherePositionVelocityStruct &sphere_pvs,
...
bool ForceSphereWallMeshHertz::check_possible_collision(
    SpherePositionVelocityStruct &sphere_pvs,
    WallMeshPositionVelocityStruct &wallmesh_pvs,
    int indx_i, int indx_k
)
...
void ForceSphereWallMeshHertz::check_face_collision(
    bool &is_face_collision, 
    double &pos_contact_x, double &pos_contact_y, double &pos_contact_z,
    SpherePositionVelocityStruct &sphere_pvs,
    WallMeshPositionVelocityStruct &wallmesh_pvs,
...
void ForceSphereWallMeshHertz::check_edge_collision(
    bool &is_edge_collision,
    double &pos_contact_x, double &pos_contact_y, double &pos_contact_z,
    SpherePositionVelocityStruct &sphere_pvs,
    WallMeshPositionVelocityStruct &wallmesh_pvs,
...
void ForceSphereWallMeshHertz::check_vertex_collision(
    bool &is_vertex_collision,
    double &pos_contact_x, double &pos_contact_y, double &pos_contact_z,
    SpherePositionVelocityStruct &sphere_pvs,
    WallMeshPositionVelocityStruct &wallmesh_pvs,
...
void ForceSphereWallMeshHertz::calculate_velocity_contact(
    double &vel_contact_x, double &vel_contact_y, double &vel_contact_z,
    WallMeshPositionVelocityStruct &wallmesh_pvs,
    double pos_contact_x, double pos_contact_y, double pos_contact_z
)
